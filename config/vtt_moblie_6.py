_base_ = [
    './base/dataset_vtt_6.py', './base/schedule_sgd.py', './base/default_runtime.py'
]

data_preprocessor = dict(
    type = 'VTTClsDataPreprocessor',
    num_classes=6,
...
model = dict(
    ...
    neck=dict(type='VTTAPooling', 
              Table = True, 
              bert_model_name = '/home/user/ZY_Workspace/Django_VTmamba/VTmamba/Bert-Chinese-Text-Classification-Pytorch-master.zip/Bert-Chinese-Text-Classification-Pytorch-master/bert_pretrain'),
    head=dict(
        type='VTTClsHead',
        num_classes=6,
        in_channels=2048,
...
work_dir = './experiments/med_classfiy/results/VTT/resnet50_598/' + f'{lr}_{batch_size}'