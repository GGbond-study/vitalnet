...
class VTClassifier(BaseClassifier):
    ...
    def forward(self,
        ...
        if mode == 'tensor':
            ...
            return self.loss(inputs, inputs_table, data_samples)
        elif mode == 'predict':
            return self.predict(inputs, inputs_table, data_samples,)
        else:
            raise RuntimeError(f'Invalid mode "{mode}".')

    def extract_feat(self, inputs, inputs_table, stage='neck'):
    ...
    def loss(self, inputs: torch.Tensor,
        ...
        """
        feats = self.extract_feat(inputs, inputs_table)
