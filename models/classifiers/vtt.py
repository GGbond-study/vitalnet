...
class VTTClassifier(BaseClassifier):
    ...
    def __init__(self,
        ...
        if isinstance(data_preprocessor, dict):
            data_preprocessor.setdefault('type', 'VTTClsDataPreprocessor')
        ...
        super(VTTClassifier, self).__init__(
    ...
    def forward(self,
        ...
        if mode == 'tensor':
            ...
            return self.loss(inputs, inputs_table, inputs_text, data_samples,)
        elif mode == 'predict':
            return self.predict(inputs, inputs_table, inputs_text, data_samples,)
        else:
            raise RuntimeError(f'Invalid mode "{mode}".')

    def extract_feat(self, inputs, inputs_table, inputs_text, stage='neck'):
        ...
        if self.with_neck:
            x = self.neck(x, inputs_table, inputs_text)
        if stage == 'neck':
            return x
    ...
    def loss(self, inputs: torch.Tensor,
        ...
        """
        feats = self.extract_feat(inputs, inputs_table, inputs_text)
    ...
    def train_step(self, data: Union[dict, tuple, list],
        ...
        with optim_wrapper.optim_context(self):
            #print(data.keys())
            table = data['inputs_table']
            data = self.data_preprocessor(data, True)
            data['inputs_table'] = table
            #print(data.keys(), len(data['inputs']))
